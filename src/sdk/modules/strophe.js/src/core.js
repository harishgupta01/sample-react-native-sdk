...
Strophe.Connection.prototype = {
    ...
    */
    ...
    _connect_cb: function (req, _callback, raw) {
        ...
        if(bodyWrap.getElementsByTagName("stream:features")){
            hasFeatures = bodyWrap.getElementsByTagName("stream:features").length > 0 ||
                bodyWrap.getElementsByTagName("features").length > 0;
        }
...
Strophe.SASLNoauth = function() {};
Strophe.SASLNoauth.prototype = new Strophe.SASLMechanism("NOAUTH", false, 80);

Strophe.SASLNoauth.prototype.test = function(connection) {
    return;
};
