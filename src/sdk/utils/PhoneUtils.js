...
var PhoneUtils = {
    ...
    hasStarCode: function(num) {
        ...
        try {
            ...
            logger.Error(Tag, "Error in hasStarCode : ", err);
            throw err;
        }
    },
    ...
    hasE164Prefix: function(num) {
        try {
            ...
            logger.Error(Tag, "Error in hasE164Prefix : ", err);
            throw err;
        }
    },
    ...
    isNonStdTN: function(num) {
        try {
            ...
            logger.Error(Tag, "Error in isNonStdTN : ", err);
            throw err;
        }
    },
    ...
    getTN: function(num) {
        ...
        try {
            ...
            logger.Error(Tag, "Error in getTN : ", err);
    ...
    getE164TelephoneNumber: function(num) {
        ...
        try {
            ...
            logger.Error(Tag, "Error in getE164TelephoneNumber : ", err);
    ...
    getStarCode: function(num) {
        ...
        try {
            ...
            logger.Error(Tag, "Error in getStarCode : ", err);
    ...
    getRayoIQNumber: function(num) {
        ...
        try {
            ...
            logger.Error(Tag, "Error in getRayoIQNumber : ", err);
    ...
    getMUCRequestNumber: function(num) {
        ...
        try {
            ...
            logger.Error(Tag, "Error in getMUCRequestNumber : ", err);
